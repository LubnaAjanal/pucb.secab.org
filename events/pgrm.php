    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <h2>Department Of Arts Organized A Program For The Students.</h2>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <ul class="bread-list">
                    <li><a href="index.html">Home<i class="fa fa-angle-right"></i></a></li>
                    <li class="active"><a href="#">Department Of Arts Organized A Program For The Students.<i class="fa fa-angle-right"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
