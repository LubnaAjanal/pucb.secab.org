    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <h2>Parent - Teacher Meet 2019</h2>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <ul class="bread-list">
                    <li><a href="index.html">Home<i class="fa fa-angle-right"></i></a></li>
                    <li class="active"><a href="#">Parent - Teacher Meet 2019</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<section id="international-womens-day" class="mt-5 mb-5">
    <div class="container">
        <h2 class="bom-title">Parent - Teacher Meet 2019</h2>
        <div class="row">
            <div class="col-md-8">
                <p>SECAB PU College for Boys, A Parent_ Teacher Meet of Arts and Commerce Department was held today, 
                    where in the performance and attendance of the students was discussed.</p>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-4">
